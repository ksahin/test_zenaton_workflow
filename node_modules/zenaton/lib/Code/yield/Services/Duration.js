...
class Duration {
  ...
  seconds(seconds) {
    if (!Number.isInteger(seconds)) {
      throw new ExternalZenatonError("Parameter of 'duration.seconds' must be an integer");
    }
  ...
  minutes(minutes) {
    if (!Number.isInteger(minutes)) {
      throw new ExternalZenatonError("Parameter of 'duration.minutes' must be an integer");
    }
  ...
  hours(hours) {
    if (!Number.isInteger(hours)) {
      throw new ExternalZenatonError("Parameter of 'duration.hours' must be an integer");
    }
  ...
  days(days) {
    if (!Number.isInteger(days)) {
      throw new ExternalZenatonError("Parameter of 'duration.days' must be an integer");
    }
  ...
  weeks(weeks) {
    if (!Number.isInteger(weeks)) {
      throw new ExternalZenatonError("Parameter of 'duration.weeks' must be an integer");
    }
  ...
  months(months) {
    if (!Number.isInteger(months)) {
      throw new ExternalZenatonError("Parameter of 'duration.months' must be an integer");
    }
  ...
  years(years) {
    if (!Number.isInteger(years)) {
      throw new ExternalZenatonError("Parameter of 'duration.years' must be an integer");
    }
  ...
  get(definition, baseDate) {
    ...
    const date = now.clone(); // eslint-disable-next-line no-plusplus
