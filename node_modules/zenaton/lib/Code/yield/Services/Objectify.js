...
const objectify = function objectify(Class, ...input) {
  if (typeof Class !== "function") {
    throw new InternalZenatonError(`Parameter of "objectify" must be a function, not a "${typeof Class}"`);
  ...
  Object.getOwnPropertyNames(Class.prototype).forEach(method => {
    if (method !== "constructor" && !method.startsWith("_") && typeof Class.prototype[method] === "function") {
