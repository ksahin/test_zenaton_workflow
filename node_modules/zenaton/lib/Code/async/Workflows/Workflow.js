...
module.exports = function workflowFunc(name, flow) {
  ...
  if (typeof flow !== "function" && typeof flow !== "object") {
    throw new InvalidArgumentError("2nd parameter (workflow implemention) must be a function or an object");
  }
  ...
  const WorkflowClass = class extends AbstractWorkflow {
    ...
    _getCustomId() {
      ...
      if (typeof this.id === "function") {
        ...
        customId = this.id(); // customId should be a string or a number
