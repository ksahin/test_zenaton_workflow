...
module.exports = class Client {
  ...
  getGatewayUrl() {
    const host = process.env.ZENATON_GATEWAY_URL ? process.env.ZENATON_GATEWAY_URL : ZENATON_GATEWAY_URL;
    return host;
  }
  /**
  ...
  async startInstantTask(task) {
    const url = this.getWorkerUrlNew("tasks"); // start task
  ...
  async startInstantWorkflow(flow) {
    const url = this.getWorkerUrlNew("instances"); // start workflow
